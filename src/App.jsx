...
export default function MenuQr() {
  ...
  const send = () => {
    ...
    window.open(`https://wa.me/${WA}?text=${encodeURIComponent(t.waMsg(form))}`, "_blank");
  };
